...
# See original Github Repo: https://github.com/lamw/vghetto-vsphere-with-kubernetes-external-nsxt-automated-lab-deployment#enable-workload-management

# vCenter Server used to deploy vSphere with Kubernetes Lab
$VIServer = "vcenter.localdomain" #CHECKTHISLINE
$VIUsername = "administrator@vsphere.local" #CHECKTHISLINE
$VIPassword = "VMware1!" #CHECKTHISLINE

# Full Path to both the Nested ESXi 7.0 VA, Extracted VCSA 7.0 ISO & NSX-T OVAs
$NestedESXiApplianceOVA = "C:\vmware\Nested_ESXi7.0_Appliance_Template_v1.ova" #CHECKTHISLINE
$VCSAInstallerPath = "C:\vmware\VMware-VCSA-all-7.0.1-17327517" #CHECKTHISLINE
$NSXTManagerOVA = "C:\vmware\nsx-unified-appliance-3.1.0.0.0.17107212-le.ova" #CHECKTHISLINE
$NSXTEdgeOVA = "C:\vmware\nsx-edge-3.1.0.0.0.17107215-le.ova" #CHECKTHISLINE

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = @{
    "pacific-esxi-7" = "192.168.0.12" #CHECKTHISLINE
}

# Nested ESXi VM Resources
$NestedESXivCPU = "4"
$NestedESXivMEM = "36" #GB , CHECKTHISLINE
$NestedESXiCachingvDisk = "8" #GB
$NestedESXiCapacityvDisk = "300" #GB, CHECKTHISLINE

# VCSA Deployment Configuration
$VCSADeploymentSize = "tiny"
$VCSADisplayName = "pacific-vcsa-3"
$VCSAIPAddress = "192.168.0.13" #CHECKTHISLINE
...
$VMDatacenter = "Datacenter" #CHECKTHISLINE
$VMCluster = "vSAN cluster" #CHECKTHISLINE
$VMNetwork = "DSwitch-Management Network" #CHECKTHISLINE
$VMDatastore = "vsanDatastore"
$VMNetmask = "255.255.255.0"
$VMGateway = "192.168.0.1" #CHECKTHISLINE
$VMDNS = "192.168.0.40" #CHECKTHISLINE
$VMNTP = "pool.ntp.org"
$VMPassword = "VMware1!"
$VMDomain = "cpbu.corp"
$VMSyslog = "192.168.0.13" #CHECKTHISLINE
...
# NSX-T Configuration
$NSXLicenseKey = "<license-key-here>" #CHECKTHISLINE
...
$T0GatewayInterfaceAddress = "192.168.0.14" # should be a routable address, CHECKTHISLINE
...
$T0GatewayInterfaceStaticRouteAddress = "192.168.0.1" #CHECKTHISLINE
...
$NSXTMgrvCPU = "4" #override default size, CHECKTHISLINE
$NSXTMgrvMEM = "12" #override default size, CHECKTHISLINE
$NSXTMgrDisplayName = "pacific-nsx-3"
$NSXTMgrHostname = "pacific-nsx-3.cpbu.corp"
$NSXTMgrIPAddress = "192.168.0.15" #CHECKTHISLINE
...
$NSXTEdgeHostnameToIPs = @{
    "pacific-nsx-edge-3a" = "192.168.0.16" #CHECKTHISLINE
}
...
$setupNewVC = 1
$addESXiHostsToVC = 1
$configureVSANDiskGroup = 0 #CHECKTHISLINE
$configureVDS = 1
$clearVSANHealthCheckAlarm = 0 #CHECKTHISLINE
$setupPacificStoragePolicy = 1
$deployNSXManager = 1
$deployNSXEdge = 1
$postDeployNSXConfig = 1
$setupPacific = 1
$moveVMsIntovApp = 0 #CHECKTHISLINE
